...
### Changed
* [809](https://github.com/dbekaert/RAiDER/pull/809) - Update raiderCombine.py to add a datetime column on-the-fly. Previously running raiderDownloadGNSS.py and then raiderCombine.py directly after could fail. 
