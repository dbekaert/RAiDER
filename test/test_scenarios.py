...
def test_scenario_1():
    ...
    golden_data = xr.load_dataset(os.path.join(GD_SRC_DIR, 'HRRR_tropo_20200101T120000_ztd.nc'))
...
def test_scenario_3():
    ...
    golden_data = xr.load_dataset(os.path.join(GD_SRC_DIR, 'HRRR_tropo_20181113T230000_std.nc'))
