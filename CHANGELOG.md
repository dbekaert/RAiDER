...
### Fixed
* [816](https://github.com/dbekaert/RAiDER/pull/816) - For HRRR availability checks, skip retired Herbie mirror sources (pando/pando2) to avoid connection timeouts on unavailable timestamps.
