...
#        self.grid = self._import_grids()
    ...
    @classmethod
    def _make_grid(self, tempNoData=np.nan, humidNoData=np.nan,
                     geoHgtNoData=np.nan, scipy_interpolate=False,
        ...
        self._get_ll()
        self._get_heights(geoHgtNoData)
...
def import_grids(xs, ys, pressure, temperature, humidity, geo_ht,
    ...
    def getInterpFcn(self, scipy_interpolate = False):
        ...
        '''
        self.interpFcn = LinearModel(xs=self.xs, ys=self.ys, heights=self.heights,
                           pressure=self.p,
                           temperature=self.t, humidity=self.q,
                           k1=self._k1, k2=self._k2, k3=self._k3, projection=self.projection,
                           scipy_interpolate=scipy_interpolate,
                           humidity_type=self._humidity_type, zmin=self._zmin)

        print(self.interpFcn)
...
class ERAI(ECMWF):
    ...
    _a = [0.0000000000e+000, 2.0000000000e+001, 3.8425338745e+001,
         ...
         0.0000000000e+000]
    _b = [0.0000000000e+000, 0.0000000000e+000, 0.0000000000e+000,
...
class ERA5(ECMWF):
    ...
    _a = [0.000000,     2.000365,     3.102241,     4.666084,     6.827977,
    ...
    _b = [0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,
